...
embedding_fn=GoogleGenerativeAiEmbeddingFunction(api_key=os.environ.get("GEMINI_API_KEY"),task_type="RETRIEVAL_DOCUMENT", model_name="models/gemini-embedding-001")
